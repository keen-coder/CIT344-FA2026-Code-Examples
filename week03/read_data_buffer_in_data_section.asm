...
;
; assembler command:    yasm -felf64 -gdwarf2 read_data_buffer_in_data_section.asm -l read_data_buffer_in_data_section.lst
; linker command:       ld -g -o read_data_buffer_in_data_section read_data_buffer_in_data_section.o
...
strBuffer		db		"                                                  ", NULL
BUFFER_SIZE		EQU		$ - strBuffer			; Store the size of the entire buffer using the $- trick
